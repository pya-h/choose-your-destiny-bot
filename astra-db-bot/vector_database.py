from cassandra.cluster import Cluster, ProtocolVersion, EXEC_PROFILE_DEFAULT, ExecutionProfile
...
class CassandraDatabase:
    ...
    def connect(self, chat_id):
        ...
        self.cluster = Cluster(cloud=cloud_config, auth_provider=auth_provider, protocol_version=ProtocolVersion.V4, execution_profiles={EXEC_PROFILE_DEFAULT: profile})
